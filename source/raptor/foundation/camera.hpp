...
struct Camera {
  ...
  void init_perpective(f32 near_plane, f32 far_plane, f32 fov_y,
                       f32 aspect_ratio);
  void init_orthographic(f32 near_plane, f32 far_plane, f32 viewport_width,
                         f32 viewport_height, f32 zoom);
  ...
  static void yaw_pitch_from_direction(const vec3s& direction, f32& yaw,
                                       f32& pitch);
