...
void ResourceManager::init(Allocator* allocator_,
                           ResourceFilenameResolver* resolver) {
...
void ResourceManager::set_loader(cstring resource_type,
                                 ResourceLoader* loader) {
  const u64 hashed_name = hash_calculate(resource_type);
  loaders.insert(hashed_name, loader);
}

void ResourceManager::set_compiler(cstring resource_type,
