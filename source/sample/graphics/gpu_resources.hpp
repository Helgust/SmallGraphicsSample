...
struct ShaderStateCreation {
  ...
  ShaderStateCreation& add_stage(const char* code, u32 code_size,
...
struct RenderPassOutput {
  ...
  RenderPassOutput& set_operations(RenderPassOperation::Enum color,
...
struct RenderPassCreation {
  ...
  RenderPassCreation& set_operations(RenderPassOperation::Enum color,
                                     RenderPassOperation::Enum depth,
                                     RenderPassOperation::Enum stencil);
...
struct Pipeline {
  ...
  DescriptorSetLayoutHandle
      descriptor_set_layout_handle[k_max_descriptor_set_layouts];
  u32 num_active_layouts = 0;
