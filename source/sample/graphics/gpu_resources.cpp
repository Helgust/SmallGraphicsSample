...
ShaderStateCreation& ShaderStateCreation::add_stage(
    const char* code, u32 code_size, VkShaderStageFlagBits type) {
...
RenderPassOutput& RenderPassOutput::reset() {
  ...
  color_operation = depth_operation = stencil_operation =
      RenderPassOperation::DontCare;
  return *this;
}
...
RenderPassOutput& RenderPassOutput::set_operations(
    RenderPassOperation::Enum color_, RenderPassOperation::Enum depth_,
...
RenderPassCreation& RenderPassCreation::add_render_texture(
...
RenderPassCreation& RenderPassCreation::set_scaling(f32 scale_x_, f32 scale_y_,
                                                    u8 resize_) {
  scale_x = scale_x_;
  scale_y = scale_y_;
  resize = resize_;
...
RenderPassCreation& RenderPassCreation::set_depth_stencil_texture(
    TextureHandle texture) {
...
RenderPassCreation& RenderPassCreation::set_operations(
    RenderPassOperation::Enum color_, RenderPassOperation::Enum depth_,
    RenderPassOperation::Enum stencil_) {
  color_operation = color_;
  depth_operation = depth_;
...
ExecutionBarrier& ExecutionBarrier::add_memory_barrier(
